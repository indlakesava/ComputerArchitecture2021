...
public class Simulator extends javax.swing.JFrame {
    ...
    private void cycle(){
        //Method that keeps track of PC, MAR, MBR, IR and passes instruction further if we didn't reach the end of instruction set
        try {
            Assembler assembler_obj = new Assembler();
    ...
    private void LD_operation(String reg)
    {
        ...
        {
            txtarea_instructions.setText("Please check the number of bits for each field in instruction format at the bottom");
        }
    }
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(btn_Run, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(8, 8, 8)
                                        .addComponent(lblI)
                                        .addGap(30, 30, 30)
                                    ...
                                    .addComponent(btn_SI, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
